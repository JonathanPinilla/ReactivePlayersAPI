...
@Service
public class UnEquipArmorUseCase implements BiFunction<Armor, String, Mono<PlayerDTO>>{

    private final ModelMapper modelMapper;
    private final PlayerRepository playerRepository;

    public UnEquipArmorUseCase(ModelMapper modelMapper, PlayerRepository playerRepository) {
